...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Reylee"
    user-mail-address "reynard_lee_from.tp@mom.gov.sg")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/reylee/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/reylee/bin" "/profile/bin" "/Users/reylee/.npm-packages/bin" "/Users/reylee/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
